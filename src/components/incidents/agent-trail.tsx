...
const agentColors: Record<string, string> = {
	...
	Triage: "bg-cyan-100 text-cyan-700 dark:bg-cyan-950 dark:text-cyan-300",
	...
	Debugger: "bg-amber-100 text-amber-700 dark:bg-amber-950 dark:text-amber-300",
	"QA Reviewer": "bg-rose-100 text-rose-700 dark:bg-rose-950 dark:text-rose-300",
